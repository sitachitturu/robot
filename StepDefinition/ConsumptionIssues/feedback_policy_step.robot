...
*** Keywords ***
User access Consumption Issues module
...
User should redirect to service now page And User should see page Title "Material Optimization Suite"
    sleep  10s
    select window  http://surveys.ge.com/create/212122
    log location
    wait until element is visible  xpath=//*[@id="subnav-form-name"]  20s

User should see Privacy Policy link
    select window  url=${WELCOME.URL}/secure/consumption-issues
...
Input box with title "Which areas of the application does this concern?"
    sleep  6s
