...
Edit filter set title and observe udpated title
    ...
    mouse over  //*[@id="filterSetItemContainer"]/div[1]
    sleep  3s
    wait until element is visible  //*[@id="filterSetItemContainer"]/div[2]/div[3]/i   10s
    double click element  //*[@id="filterSetItemContainer"]/div[2]/div[3]/i
    sleep  4s
    ...
    run keyword and ignore error  should be equal as strings  ${Product Name unique value3}  ${text_after_edit}
...
delete all bookamrks from custom view
