...
Resource  ../../StepDefinition/ReceiptOptamization/filters_receipt_optimization_step.robot
*** Test Cases ***
Check Filters on Receipt Optimization
   ...
   # When User check check box with "Buyer / Purch. Group" name
    #When User check check box with "Vendor Name" name
...
Verify Reacipt opt. module whether the copyright is changed 2017 to 2018 or not
